  ...
  return (
    <div>
      <div className="relative h-[120px] w-full lg:h-[200px] flex items-center justify-center rounded-3xl overflow-hidden">
        ...
        />
        <h1 className="absolute text-xl top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 text-white text-4xl font-bold">
          Education
        </h1>
      </div>
      <div className="flex items-center justify-between">
        <p className="lg:flex-1 lg:text-center lg:text-6 text-base text-text2 font-bold">
          524 Projects Found
        </p>
