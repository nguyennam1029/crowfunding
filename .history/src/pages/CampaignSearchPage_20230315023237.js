    ...
    <div>
      ...
      <div className="flex items-center justify-between">
        {campaigns.length > 0 ? (
          ...
          <p className="mt-40 text-base font-bold lg:flex-1 lg:text-center lg:text-2xl text-text2">
        ...
        {campaigns.length > 0 && (
          <div className="flex items-center justify-between gap-1 px-4 py-2 my-6 text-sm border rounded cursor-pointer text-slate-700 lg:text-lg border-text4 lg:my-8">
            <span>Trending</span>
            <span>
              <svg
