  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        <p>524 Projects Found</p>
        <div className="flex items-center justify-between py-2 px-4 gap-1 border border-text3 rounded mx-6 lg:mx-8">
          <span className="lg:flex-1 text-center">Trending</span>
          <span>
            <svg
