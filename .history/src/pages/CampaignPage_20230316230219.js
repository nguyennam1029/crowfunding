  ...
  return (
    <Fragment>
      ...
      <div className="flex items-center justify-between mb-10">
        <Heading
          number={campaigns.length > 0 && campaigns.length}
          className="flex-1"
        >
          Your campaign
        </Heading>
        <div className="bg-white rounded-full shadow-[10px_10px_20px_rgba(218,_213,_213,_0.95)] p-2  flex items-center ">
          <div className="flex-1 px-5">
            <input
              type="text"
              placeholder="Do fundrise now"
              className="w-[400px] text-sm bg-transparent placeholder:text-text3 text-text1"
          ...
          <button
            ...
            className="w-[72px] rounded-full bg-secondary text-white h-10 flex items-center justify-center flex-shrink-0"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-6 h-6"
