...
const ImageUpload = ({ onChange = () => {}, name = "", image }) => {
  ...
  return (
    <label className=" relativew-full h-[200px] border border-gray-200 border-dashed rounded-xl cursor-pointer flex items-center justify-center">
      ...
      <Fragment>
        {image && (
          <div className="absolute top-0 left-0 flex flex-col items-center w-full h-full text-center pointer-events-none">
            <img
              src={image}
              alt="upload-img"
