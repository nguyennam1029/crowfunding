...
const DashboardTopbar = () => {
  ...
  return (
    <div className="flex items-center justify-between pb-3 mb-8 shadow-lg">
      ...
      <div className="flex items-center justify-end flex-1 gap-x-10">
        ...
        <div className="relative flex items-center justify-center gap-3">
          ...
          <div className="absolute w-[360px]  right-0 top-[74px] p-4 z-10  rounded-xl shadow-2xl bg-white">
