    ...
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex items-center justify-end flex-1 gap-x-10">
        ...
        <div className="relative flex items-center justify-center gap-3">
          ...
          <div className="absolute w-[360px]  right-0 top-[74px] p-4 z-10  rounded-xl shadow-2xl bg-grayf5">
            <Link
              to={"/info"}
            ...
            >
              ...
              />
              <h3 className="mt-4 mb-2 text-xl font-medium text-darkSoft">
            ...
            <div>
              <ul>
                <li className="flex items-center gap-x-4 text-base text-[#484848] font-semibold">
                  <span>
                    <svg
                      width="24"
                      height="24"
