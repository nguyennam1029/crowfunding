...
const CampaignFeature = ({ item, crud = false }) => {
  ...
  return (
    <div className="flex items-center gap-x-[30px] w-full max-w-[1048px] transition duration-500 ease-in-out shadow-lg rounded-2xl hover:-translate-y-2 hover:shadow-2xl">
      <CampImage
        ...
        {crud ? (
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <span
                className="cursor-pointer"
                onClick={() => navigate(`/update-campaign/${item?.id}`)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
